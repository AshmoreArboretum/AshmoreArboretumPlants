---
layout: default
title: rhododendron autumn lilac
common_name: Azalea - Autumn Lilac Encore
scientific_name: Rhododendron 'Robles' PP22762
---
...
- **Water Needs/Environment Needs:** Consistently moist but well-drained, acidic soil (pH 5.0-5.5 preferred); organic-rich; mulch to retain moisture and cool roots; avoid wet feet to prevent root rot.
- **Zone Range:** 6-10
- **Size:** 3 feet tall × 3.5 feet wide (mature; compact rounded form)
- **Bloom Color:** Lavender with dark purple freckles
- **Prominent Features:** 2-3 inch single funnel-shaped flowers; reblooms in spring, summer, and fall; evergreen with glossy dark green foliage; attracts butterflies and pollinators; dense, upright growth habit; suitable for borders, foundations, hedges, containers, or mass plantings.
...
- [Plant Addicts](https://plantaddicts.com/autumn-lilac-encore-azalea)
- [Missouri Botanical Garden](https://www.missouribotanicalgarden.org/PlantFinder/PlantFinderDetails.aspx?taxonid=272158)
- [US Plant Patent PP22762](https://patents.google.com/patent/USPP22762)
